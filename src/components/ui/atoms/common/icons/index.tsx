...
import { UserIconPath, UserSecondIconPath } from "./svgs";

export const MenuHamburgerIcon = (props: IconProps) => {
	return (
...
const Icons = { MenuHamburgerIcon, MainLogo };
